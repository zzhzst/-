		   	...
		   	<c:choose>
				<c:when test="${empty sessionScope.currUser}">
					  <ul class="nav nav-list">
			               ...
			               <li class="active font"><a href="${path}/eboard/showNews "target="body">职位新闻</a></li>
			               <li class="active font"><a href="${path}/main/registCom" target="_parent">企业注册</a></li>
			               <li class="active font"><a href="${path}/main/companyLogin" target="_parent">企业登录</a></li>
			           </ul>
				</c:when>
				<c:when test="${!empty sessionScope.currUser}">
			           <ul class="nav nav-list">
